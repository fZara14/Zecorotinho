    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
	          	...
	          	<div class="w-100"></div>
	          	<div class="col-md-12">
	          		<p style="color: #000;">80 unidades disponíveis</p>
	          	</div>
          	</div>
          	<p><a href="cart.php" class="btn btn-primary py-3 px-5 mr-2">Adicionar ao carrinho</a><a href="cart.php" class="btn btn-primary py-3 px-5">Comprar</a></p>
    			</div>
    		</div>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
              	<div class="row p-4">
						   		<div class="col-md-7">
						   			<h3 class="mb-4">23 Avaliações</h3>
						   			<div class="review">
